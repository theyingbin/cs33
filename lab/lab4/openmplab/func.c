...
void func0(double *weights, double *arrayX, double *arrayY, int xr, int yr, int n)
{
	...
	// Use multiple threads to run this in parallel by keeping certain variables private to other threads
...
#pragma omp parallel for private(i)
	...
	// Use multiple threads to run this in parallel by telling the OpenMP we are using an accumulator
...
void func3(double *arrayX, double *arrayY, double *weights, double *x_e, double *y_e, int n)
{
	...
	// Use multiple threads to run this in parallel by keeping certain variables private to other threads and telling OpenMp we are using an accumulator
